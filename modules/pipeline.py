...
def pipeline() -> None:
    df = pd.read_csv("C:\\Users\\khari\\PythonProject\\airflow_hw\\airflow_hw\\data\\train\\homework.csv"
)
    ...
    model_filename = f"C:\\Users\\khari\\PythonProject\\airflow_hw\\airflow_hw\\data\\models\\cars_pipe_{datetime.now().strftime('%Y%m%d%H%M')}.pkl"
